...
var len__28475__auto___41678 = arguments.length;
var i__28476__auto___41679 = (0);
while(true){
if((i__28476__auto___41679 < len__28475__auto___41678)){
args__28482__auto__.push((arguments[i__28476__auto___41679]));

var G__41680 = (i__28476__auto___41679 + (1));
i__28476__auto___41679 = G__41680;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41675){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__41676,G__41677,seq41675__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41681_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__41681_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__41690__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41694){var e__39241__auto__ = e41694;
return false;
}})();
if(cljs.core.truth_(or__27400__auto__)){
return or__27400__auto__;
...
}catch (e41696){var e__39241__auto__ = e41696;
return false;
}}
})())){
...
var _STAR_current_state_STAR_41701 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__41702 = opts;
...
var markup_db = cljs.core.get.call(null,map__41702__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_41701;
}});
...
;
var temp__4655__auto___41707 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___41707)){
var managed_print_level_41708 = temp__4655__auto___41707;
var _STAR_print_level_STAR_41706_41709 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_41708;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_41706_41709,managed_print_level_41708,temp__4655__auto___41707,writer,opts,job_fn){
return (function (p1__41704_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__41704_SHARP_,null);
});})(_STAR_print_level_STAR_41706_41709,managed_print_level_41708,temp__4655__auto___41707,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_41706_41709;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1481770150248