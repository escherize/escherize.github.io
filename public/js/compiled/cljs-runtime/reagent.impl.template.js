...
var G__37228 = o;
(G__37228[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37230 = o;
(G__37230[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37434__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37435__i < G__37435__a.length) {G__37435__a[G__37435__i] = arguments[G__37435__i + 0]; ++G__37435__i;}
  args = new cljs.core.IndexedSeq(G__37435__a,0,null);
} 
return G__37434__delegate.call(this,args);};
G__37434.cljs$lang$maxFixedArity = 0;
G__37434.cljs$lang$applyTo = (function (arglist__37437){
var args = cljs.core.seq(arglist__37437);
return G__37434__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37241){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37242__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__37242,map__37242__$1,props,class$){
return (function (c){
...
});})(map__37242,map__37242__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37245){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37246__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37246,map__37246__$1,on_write){
return (function (){
...
});})(node_value,map__37246,map__37246__$1,on_write))
);
} else {
...
var G__37288 = jsprops;
(G__37288["defaultValue"] = value);

(G__37288["onChange"] = ((function (G__37288,v,value,on_change){
return (function (p1__37251_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37251_SHARP_);
});})(G__37288,v,value,on_change))
);
...
var vec__37317 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37317,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37317,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37317,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___37568 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___37568 == null)){
} else {
var key_37569 = temp__5724__auto___37568;
(jsprops["key"] = key_37569);
}
...
var temp__5724__auto___37570 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___37570 == null)){
} else {
var key_37571 = temp__5724__auto___37570;
reagent.impl.template.oset(jsprops,"key",key_37571);
}
...
var G__37339 = reagent.impl.template.__GT_NativeWrapper();
(G__37339["name"] = c);
...
var G__37354 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37354) : reagent.impl.template.as_element.call(null,G__37354));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37363){
var G__37364 = cljs.core.first(seq37363);
var seq37363__$1 = cljs.core.next(seq37363);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37364,seq37363__$1);
});
...
break;
default:
var G__37600 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37600;
continue;
...
var n__4607__auto___37605 = a.length;
var i_37606 = (0);
while(true){
if((i_37606 < n__4607__auto___37605)){
(a[i_37606] = reagent.impl.template.as_element((a[i_37606])));
...
var val_37610 = (a[i_37609]);
if(((cljs.core.vector_QMARK_(val_37610)) && ((reagent.impl.template.key_from_vec(val_37610) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37609] = reagent.impl.template.as_element(val_37610));

var G__37615 = (i_37609 + (1));
i_37609 = G__37615;
continue;
} else {
}
...
var ctx = ({});
var vec__37393 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37393,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37393,(1),null);
...
var G__37409 = (cljs.core.count(argv) - first_child);
switch (G__37409) {
case (0):
...
case (1):
var G__37410 = comp;
var G__37411 = jsprops;
var G__37412 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37410,G__37411,G__37412);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37409){
