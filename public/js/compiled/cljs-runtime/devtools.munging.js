...
var o37180 = temp__5733__auto__;
var temp__5733__auto____$1 = (o37180["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o37181 = temp__5733__auto____$1;
return (o37181["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36487__auto__ = f;
return (o__36487__auto__["toString"]).call(o__36487__auto__);
} else {
return "";
}
}catch (e37189){var _ = e37189;
return "";
}});
...
try{var o__36487__auto___37824 = t;
(o__36487__auto___37824["cljs$lang$ctorPrWriter"]).call(o__36487__auto___37824,t,writer);
}catch (e37211){var __37826 = e37211;
}
...
var char_code = (function (){var o__36487__auto__ = (new String(char$));
return (o__36487__auto__["charCodeAt"]).call(o__36487__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36487__auto__ = String;
return (o__36487__auto__["fromCharCode"]).call(o__36487__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37241 = num_code;
switch (G__37241) {
case (1):
return (185);
...
var o__36487__auto__ = String;
return (o__36487__auto__["fromCharCode"]).call(o__36487__auto__,superscript_code);
});
/**
...
}catch (e37289){var _e__36502__auto__ = e37289;
return false;
}})())){
...
var vec__37301 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37301,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o37353 = temp__5733__auto__;
var temp__5733__auto____$1 = (o37353["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o37354 = temp__5733__auto____$1;
return (o37354["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37386){
var vec__37387 = p__37386;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37387,(0),null);
...
var G__37867 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__37868 = cljs.core.butlast(remaining_tokens);
name_tokens = G__37867;
remaining_tokens = G__37868;
continue;
}
}
break;
...
var vec__37416 = cljs.core.split_with((function (p1__37415_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37415_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37416,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37416,(1),null);
...
var vec__37436 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37436,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37436,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__37880 = cljs.core.rest(remaining_tokens);
var G__37881 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__37880;
name_tokens = G__37881;
continue;
} else {
...
var vec__37460 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37460,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37460,(1),null);
var vec__37463 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37463,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37463,(1),null);
var vec__37466 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(3),null);
...
var vec__37501 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37501,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__37524 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37524,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37524,(1),null);
var vec__37530 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37530,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37530,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__37558 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__37558) : devtools.munging.parse_fn_info_deep.call(null,G__37558));
})()));
}
} else {
return fn_info;
...
var G__37970 = (arity + (1));
var G__37971 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37614){
var vec__37615 = p__37614;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37615,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37615,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__37643_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__37644_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37659){
var vec__37660 = p__37659;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37660,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37649){
var G__37650 = cljs.core.first(seq37649);
var seq37649__$1 = cljs.core.next(seq37649);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37650,seq37649__$1);
});
...
var G__37685 = arg;
var G__37685__$1 = (((G__37685 instanceof cljs.core.Keyword))?G__37685.fqn:null);
switch (G__37685__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37722__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37722__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37722__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37722__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37723 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37723,(5),null);
...
var o__36487__auto__ = f;
return (o__36487__auto__["getBasis"]).call(o__36487__auto__);
});
/**
...
}catch (e37748){var _e__36502__auto__ = e37748;
...
var G__38038 = (obj[cljs.core.first(path)]);
var G__38039 = cljs.core.rest(path);
obj = G__38038;
path = G__38039;
continue;
} else {
...
return (function (accum,p__37784){
var vec__37785 = p__37784;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37785,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37785,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37797){
var vec__37798 = p__37797;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37798,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37819,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37819,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__37819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37806_SHARP_){
return (obj[cljs.core.first(p1__37806_SHARP_)]);
});})(name,sorted_matches,vec__37819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
