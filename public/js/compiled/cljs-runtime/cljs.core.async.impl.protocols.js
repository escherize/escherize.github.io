...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35153 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35153(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35157 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35157(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35158 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35158(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35161 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35161(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35162 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35162(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35169 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35169(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_35170 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_35170(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35177 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35177(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35178 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35178(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35185 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35185(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35186 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35186(b);
}
});
