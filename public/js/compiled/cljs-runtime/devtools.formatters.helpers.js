...
var G__32568 = devtools.prefs.pref(v);
v = G__32568;
continue;
} else {
return v;
...
}catch (e32501){var _e__31338__auto__ = e32501;
return false;
}})();
...
}catch (e32507){var _e__31338__auto__ = e32507;
return false;
}})();
...
}catch (e32511){var _e__31338__auto__ = e32511;
return false;
}}
}
});
...
var vec__32537 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32537,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32537,(1),null);
...
return cljs.core.some((function (p1__32545_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__32545_SHARP_);
}),template);
});
