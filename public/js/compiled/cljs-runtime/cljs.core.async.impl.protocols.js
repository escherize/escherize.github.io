...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35144 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_35144(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35147 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_35147(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35148 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_35148(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35149 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_35149(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35150 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_35150(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35151 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_35151(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_35152 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_35152(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35153 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_35153(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35154 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_35154(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35155 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_35155(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35156 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_35156(b);
}
});
