...
var o26341 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26341["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26342 = temp__5733__auto____$1;
return (o26342["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26045__auto__ = f;
return (o__26045__auto__["toString"]).call(o__26045__auto__);
} else {
return "";
}
}catch (e26363){var _ = e26363;
return "";
}});
...
try{var o__26045__auto___26905 = t;
(o__26045__auto___26905["cljs$lang$ctorPrWriter"]).call(o__26045__auto___26905,t,writer);
}catch (e26390){var __26907 = e26390;
}
...
var char_code = (function (){var o__26045__auto__ = (new String(char$));
return (o__26045__auto__["charCodeAt"]).call(o__26045__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26045__auto__ = String;
return (o__26045__auto__["fromCharCode"]).call(o__26045__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26430 = num_code;
switch (G__26430) {
case (1):
return (185);
...
var o__26045__auto__ = String;
return (o__26045__auto__["fromCharCode"]).call(o__26045__auto__,superscript_code);
});
/**
...
}catch (e26468){var _e__26109__auto__ = e26468;
return false;
}})())){
...
var vec__26474 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26474,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o26512 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26512["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26513 = temp__5733__auto____$1;
return (o26513["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26543){
var vec__26544 = p__26543;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26544,(0),null);
...
var G__26971 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__26972 = cljs.core.butlast(remaining_tokens);
name_tokens = G__26971;
remaining_tokens = G__26972;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26528){
var G__26529 = cljs.core.first(seq26528);
var seq26528__$1 = cljs.core.next(seq26528);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26529,seq26528__$1);
});
...
var vec__26564 = cljs.core.split_with((function (p1__26559_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26559_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26564,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26564,(1),null);
...
var vec__26579 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26579,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26579,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__26984 = cljs.core.rest(remaining_tokens);
var G__26985 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__26984;
name_tokens = G__26985;
continue;
} else {
...
var vec__26596 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26596,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26596,(1),null);
var vec__26599 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26599,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26599,(1),null);
var vec__26602 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26602,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26602,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26602,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26602,(3),null);
...
var vec__26622 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26622,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__26630 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26630,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26630,(1),null);
var vec__26637 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26637,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26637,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__26657 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__26657) : devtools.munging.parse_fn_info_deep.call(null,G__26657));
})()));
}
} else {
return fn_info;
...
var G__27027 = (arity + (1));
var G__27028 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26706){
var vec__26708 = p__26706;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26708,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26708,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__26746_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__26747_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26760){
var vec__26761 = p__26760;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26761,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26751){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26799__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26799__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26799__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26799__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26800 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26800,(5),null);
...
var o__26045__auto__ = f;
return (o__26045__auto__["getBasis"]).call(o__26045__auto__);
});
/**
...
}catch (e26813){var _e__26109__auto__ = e26813;
...
var G__27090 = (obj[cljs.core.first(path)]);
var G__27091 = cljs.core.rest(path);
obj = G__27090;
path = G__27091;
continue;
} else {
...
return (function (accum,p__26851){
var vec__26852 = p__26851;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26852,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26852,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26866){
var vec__26867 = p__26866;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26867,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26867,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26867,(2),null);
...
return (obj[cljs.core.first(p1__26877_SHARP_)]);
