...
var G__50647 = o;
(G__50647[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__50771__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50771 = function (var_args){
var args = null;
...
return G__50771__delegate.call(this,args);};
G__50771.cljs$lang$maxFixedArity = 0;
G__50771.cljs$lang$applyTo = (function (arglist__50773){
var args = cljs.core.seq(arglist__50773);
return G__50771__delegate(args);
});
G__50771.cljs$core$IFn$_invoke$arity$variadic = G__50771__delegate;
return G__50771;
})()
;
} else {
...
var G__50656 = o;
(G__50656[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
G__50779.cljs$lang$applyTo = (function (arglist__50783){
var args = cljs.core.seq(arglist__50783);
...
var G__50671 = props;
var G__50671__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50671,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50671);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50671__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50675){
var map__50677 = p__50675;
...
var props = map__50677__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50677__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50683){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50684__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__50698 = jsprops;
(G__50698["defaultValue"] = value);

(G__50698["onChange"] = (function (p1__50691_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50691_SHARP_);
}));
...
var vec__50706 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50706,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50706,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50706,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___50804 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50804 == null)){
} else {
var key_50806 = temp__5739__auto___50804;
...
var temp__5739__auto___50818 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50818 == null)){
} else {
var key_50819 = temp__5739__auto___50818;
reagent.impl.template.oset(jsprops,"key",key_50819);
}
...
var G__50718 = reagent.impl.template.__GT_NativeWrapper();
(G__50718["name"] = c);
...
var G__50723 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50723) : reagent.impl.template.as_element.call(null,G__50723));
} else {
...
var len__4789__auto___50827 = arguments.length;
var i__4790__auto___50828 = (0);
while(true){
if((i__4790__auto___50828 < len__4789__auto___50827)){
args__4795__auto__.push((arguments[i__4790__auto___50828]));

var G__50829 = (i__4790__auto___50828 + (1));
i__4790__auto___50828 = G__50829;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50734){
var G__50735 = cljs.core.first(seq50734);
var seq50734__$1 = cljs.core.next(seq50734);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50735,seq50734__$1);
}));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___50840 = a.length;
var i_50841 = (0);
while(true){
if((i_50841 < n__4666__auto___50840)){
var val_50842 = (a[i_50841]);
if(((cljs.core.vector_QMARK_(val_50842)) && ((reagent.impl.template.key_from_vec(val_50842) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_50841] = reagent.impl.template.as_element(val_50842));

var G__50843 = (i_50841 + (1));
i_50841 = G__50843;
continue;
} else {
}
...
var ctx = ({});
var vec__50760 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50760,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50760,(1),null);
...
var G__50765 = (cljs.core.count(argv) - first_child);
switch (G__50765) {
case (0):
...
case (1):
var G__50768 = comp;
var G__50769 = jsprops;
var G__50770 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__50768,G__50769,G__50770);
