...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(new_root.core.app_state,cljs.core.update,new cljs.core.Keyword(null,"thingies","thingies",2070631329),(function (p1__33300_SHARP_){
return ((2) * p1__33300_SHARP_);
}));
...
new_root.core.teaser = (function new_root$core$teaser(p__33314){
...
var _ = map__33315__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33315__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33315__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33315__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33315__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33315__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
...
new_root.core.shadow_teaser = (function new_root$core$shadow_teaser(p__33322){
...
var _ = map__33323__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33323__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33323__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33323__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33323__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33323__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
return new_root.neumorph.shadow_box.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"none",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px 20px 20px 30px",new cljs.core.Keyword(null,"margin","margin",-995903681),"60px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),new_root.core.link(title,id)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.row","div.row",133678515),(cljs.core.truth_(preview)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [preview], null):(cljs.core.truth_(content)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [content], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),title], null)
))], null)], null));
});
...
var G__33334 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [typeof id1 === 'string',typeof id2 === 'string'], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__33334)){
return id2;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__33334)){
return id1;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__33334)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__33334)){
return cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id1,id2], null)));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33334)].join('')));
...
return new_root.neumorph.wrap_shadow_container(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"Escherize Zone"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.blog,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-flow","flex-flow",544537375),"wrap"], null)], null)], null),(function (){var iter__4582__auto__ = (function new_root$core$home_$_iter__33340(s__33341){
return (new cljs.core.LazySeq(null,(function (){
var s__33341__$1 = s__33341;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__33341__$1);
if(temp__5735__auto__){
var s__33341__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__33341__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__33341__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__33343 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__33342 = (0);
while(true){
if((i__33342 < size__4581__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__33342);
cljs.core.chunk_append(b__33343,new_root.core.teaser(p));

var G__33384 = (i__33342 + (1));
i__33342 = G__33384;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33343),new_root$core$home_$_iter__33340(cljs.core.chunk_rest(s__33341__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33343),null);
}
} else {
var p = cljs.core.first(s__33341__$2);
return cljs.core.cons(new_root.core.teaser(p),new_root$core$home_$_iter__33340(cljs.core.rest(s__33341__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),"Here are some projects and toys going back to 2012."], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403)], null),(function (){var iter__4582__auto__ = (function new_root$core$projects_$_iter__33348(s__33349){
return (new cljs.core.LazySeq(null,(function (){
var s__33349__$1 = s__33349;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__33349__$1);
if(temp__5735__auto__){
var s__33349__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__33349__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__33349__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__33351 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__33350 = (0);
while(true){
if((i__33350 < size__4581__auto__)){
var project = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__33350);
cljs.core.chunk_append(b__33351,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/works/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(project)].join('')], null),clojure.string.capitalize(project)], null));

var G__33393 = (i__33350 + (1));
i__33350 = G__33393;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__33351),new_root$core$projects_$_iter__33348(cljs.core.chunk_rest(s__33349__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__33351),null);
}
} else {
var project = cljs.core.first(s__33349__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/works/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(project)].join('')], null),clojure.string.capitalize(project)], null),new_root$core$projects_$_iter__33348(cljs.core.rest(s__33349__$2)));
}
} else {
return null;
}
...
var map__33365 = (function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new_root.core.posts,id);
...
var map__33365__$1 = (((((!((map__33365 == null))))?(((((map__33365.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33365.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33365):map__33365);
var post = map__33365__$1;
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33365__$1,new cljs.core.Keyword(null,"content","content",15833224));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33365__$1,new cljs.core.Keyword(null,"title","title",636505583));
...
var G__33379 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.current_page], null);
var G__33380 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__33379,G__33380) : reagent.core.render_component.call(null,G__33379,G__33380));
});
