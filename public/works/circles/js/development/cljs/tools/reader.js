...
var G__23870 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23870;
continue;
}
break;
...
var vec__23881 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23881,(0),null);
var start_column = cljs.core.nth.call(null,vec__23881,(1),null);
...
var G__23884 = cljs.core.conj_BANG_.call(null,a,form);
a = G__23884;
continue;
}
}
...
var _STAR_read_delim_STAR_23885 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_23885;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__23886 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23886,(0),null);
var start_column = cljs.core.nth.call(null,vec__23886,(1),null);
...
var vec__23889 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23889,(0),null);
var end_column = cljs.core.nth.call(null,vec__23889,(1),null);
...
var vec__23892 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23892,(0),null);
var start_column = cljs.core.nth.call(null,vec__23892,(1),null);
...
var vec__23895 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23895,(0),null);
var end_column = cljs.core.nth.call(null,vec__23895,(1),null);
...
var vec__23898 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23898,(0),null);
var start_column = cljs.core.nth.call(null,vec__23898,(1),null);
...
var vec__23901 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23901,(0),null);
var end_column = cljs.core.nth.call(null,vec__23901,(1),null);
...
var sb = (function (){var G__23904 = (new goog.string.StringBuffer());
G__23904.append(initch);
...
var G__23906 = (function (){var G__23905 = sb;
G__23905.append(ch);

return G__23905;
})();
var G__23907 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__23906;
ch = G__23907;
continue;
}
...
switch (G__23910) {
case "\\":
var G__23914 = (function (){var G__23911 = sb;
G__23911.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23911;
})();
var G__23915 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23914;
ch = G__23915;
continue;
...
break;
default:
var G__23916 = (function (){var G__23912 = sb;
G__23912.append(ch);

return G__23912;
})();
var G__23917 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23916;
ch = G__23917;
continue;
...
var line = cljs.core.nth.call(null,vec__23921,(0),null);
var column = cljs.core.nth.call(null,vec__23921,(1),null);
...
var vec__23926 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23926,(0),null);
var column = cljs.core.nth.call(null,vec__23926,(1),null);
...
var vec__23931 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23931,(0),null);
var column = cljs.core.nth.call(null,vec__23931,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__23939 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23939,(0),null);
var end_column = cljs.core.nth.call(null,vec__23939,(1),null);
...
var G__23942 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23942,true,null,opts,pending_forms);
...
var G__23943 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__23943)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__23943)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__23943)){
...
var _STAR_suppress_read_STAR_23944 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23944;
}});
...
var G__23945 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23945,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23945,rdr,first_line);
...
var G__23949 = matched;
var G__23950 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23949;
finished = G__23950;
continue;
} else {
...
var _STAR_suppress_read_STAR_23951 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23951;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env23952 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23953 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23953,"(");
...
var G__23954 = (i + (1));
var G__23955 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env23952;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23956 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23956);
...
var G__23957 = cljs.core.next.call(null,s__$1);
var G__23958 = ret;
s__$1 = G__23957;
r = G__23958;
continue;
...
var G__23959 = cljs.core.next.call(null,s);
var G__23960 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23959;
key_vals = G__23960;
continue;
} else {
...
var gensym_env23964 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env23964;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__23965 = token;
var G__23965__$1 = (((G__23965 == null))?null:cljs.core.subs.call(null,G__23965,(1)));
var G__23965__$2 = (((G__23965__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23965__$1));
var G__23965__$3 = (((G__23965__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23965__$2));
var G__23965__$4 = (((G__23965__$3 == null))?null:cljs.core.symbol.call(null,G__23965__$3));
if((G__23965__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__23965__$4);
}
})():(function (){var G__23966 = token;
var G__23966__$1 = (((G__23966 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23966));
if((G__23966__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23966__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e23973){if((e23973 instanceof Error)){
var e = e23973;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23977,reader){
...
var eof = cljs.core.get.call(null,map__23978__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq23984){
...
//# sourceMappingURL=reader.js.map?rel=1525371772872
