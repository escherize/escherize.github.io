...
var args42081 = [];
var len__28475__auto___42087 = arguments.length;
var i__28476__auto___42088 = (0);
while(true){
if((i__28476__auto___42088 < len__28475__auto___42087)){
args42081.push((arguments[i__28476__auto___42088]));

var G__42089 = (i__28476__auto___42088 + (1));
i__28476__auto___42088 = G__42089;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args42081.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox42084 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox42084 = (function (obj,header,style,tag,meta42085){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox42084.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_42086,meta42085__$1){
var self__ = this;
var _42086__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox42084(self__.obj,self__.header,self__.style,self__.tag,meta42085__$1));
});

devtools.toolbox.t_devtools$toolbox42084.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_42086){
var self__ = this;
var _42086__$1 = this;
return self__.meta42085;
});

devtools.toolbox.t_devtools$toolbox42084.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox42084.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox42084.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox42084.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox42084.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta42085","meta42085",291134906,null)], null);
});

devtools.toolbox.t_devtools$toolbox42084.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox42084.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox42084";

devtools.toolbox.t_devtools$toolbox42084.cljs$lang$ctorPrWriter = (function (this__28006__auto__,writer__28007__auto__,opt__28008__auto__){
return cljs.core._write.call(null,writer__28007__auto__,"devtools.toolbox/t_devtools$toolbox42084");
});

devtools.toolbox.__GT_t_devtools$toolbox42084 = (function devtools$toolbox$__GT_t_devtools$toolbox42084(obj__$1,header__$1,style__$1,tag__$1,meta42085){
return (new devtools.toolbox.t_devtools$toolbox42084(obj__$1,header__$1,style__$1,tag__$1,meta42085));
});

}

return (new devtools.toolbox.t_devtools$toolbox42084(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1481770151164