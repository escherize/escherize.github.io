...
return cljs.core.merge.call(null,initial_state,p1__22808_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_22809 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_22810 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_22809);
var pos_22811 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_22809);
quil.core.scale.call(null,zoom_22810);

var tr__22567__auto___22812 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_22810) - cljs.core.first.call(null,pos_22811)),(((quil.core.height.call(null) / (2)) / zoom_22810) - cljs.core.second.call(null,pos_22811))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__22567__auto___22812);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1525371769213
