...
var G__43427 = o;
goog.object.set(G__43427,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43462__delegate = function (args){
...
while (G__43463__i < G__43463__a.length) {G__43463__a[G__43463__i] = arguments[G__43463__i + 0]; ++G__43463__i;}
  args = new cljs.core.IndexedSeq(G__43463__a,0,null);
} 
return G__43462__delegate.call(this,args);};
G__43462.cljs$lang$maxFixedArity = 0;
G__43462.cljs$lang$applyTo = (function (arglist__43464){
var args = cljs.core.seq(arglist__43464);
return G__43462__delegate(args);
});
...
var G__43428 = o;
goog.object.set(G__43428,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__43429 = props;
var G__43429__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43429,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43429);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43429__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43431 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43431,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43431;
}
})(),id_class);
...
var G__43433 = (cljs.core.count(argv) - first_child);
switch (G__43433) {
case (0):
...
var vec__43439 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43439,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43439,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43439,(2),null);
...
var temp__5757__auto___43469 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43469 == null)){
} else {
var key_43470 = temp__5757__auto___43469;
(jsprops.key = key_43470);
}
...
var temp__5757__auto___43473 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___43473 == null)){
} else {
var key_43474 = temp__5757__auto___43473;
(jsprops.key = key_43474);
}
...
var temp__5757__auto___43477 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___43477 == null)){
} else {
var key_43478 = temp__5757__auto___43477;
(jsprops.key = key_43478);
}
...
var temp__5757__auto___43480 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
var temp__5757__auto___43482 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43452_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43452_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43453 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43453,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43453,(1),null);
...
break;
default:
var G__43485 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43486 = compiler;
v = G__43485;
compiler = G__43486;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43459 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43459 = (function (opts,id,fn_to_element,meta43460){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template43459.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43461,meta43460__$1){
var self__ = this;
var _43461__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43459(self__.opts,self__.id,self__.fn_to_element,meta43460__$1));
}));

(reagent.impl.template.t_reagent$impl$template43459.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43461){
var self__ = this;
var _43461__$1 = this;
return self__.meta43460;
}));

(reagent.impl.template.t_reagent$impl$template43459.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43459.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43459.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43459.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43459.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta43460","meta43460",-853705061,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43459.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43459.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43459");

(reagent.impl.template.t_reagent$impl$template43459.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template43459");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43459.
 */
reagent.impl.template.__GT_t_reagent$impl$template43459 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43459(opts__$1,id__$1,fn_to_element__$1,meta43460){
return (new reagent.impl.template.t_reagent$impl$template43459(opts__$1,id__$1,fn_to_element__$1,meta43460));
});

}

return (new reagent.impl.template.t_reagent$impl$template43459(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
