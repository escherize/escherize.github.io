...
var G__35475 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__35475;
continue;
} else {
return ch;
...
var vec__35424 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35424,(0),null);
return (match === s);
});
...
var G__35502 = (i__4731__auto___35501 + (1));
i__4731__auto___35501 = G__35502;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq35460){
...
return (function() { 
var G__35505__delegate = function (rdr,_){
...
var G__35505 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__35507__i = 0, G__35507__a = new Array(arguments.length -  1);
while (G__35507__i < G__35507__a.length) {G__35507__a[G__35507__i] = arguments[G__35507__i + 1]; ++G__35507__i;}
  _ = new cljs.core.IndexedSeq(G__35507__a,0,null);
} 
return G__35505__delegate.call(this,rdr,_);};
G__35505.cljs$lang$maxFixedArity = 1;
G__35505.cljs$lang$applyTo = (function (arglist__35508){
var rdr = cljs.core.first(arglist__35508);
var _ = cljs.core.rest(arglist__35508);
return G__35505__delegate(rdr,_);
});
