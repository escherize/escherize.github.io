...
var digit_13618 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_13619__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_13619__$1 > (0))){
var digit_13620__$1 = (digit_13618 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_13620__$1));

var G__13621 = (vlq_13619__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__13622 = (vlq_13619__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_13618 = G__13621;
vlq_13619__$1 = G__13622;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_13618));
}
break;
}
...
var G__13623 = i__$1;
var G__13624 = result__$1;
var G__13625 = shift__$1;
i = G__13623;
result = G__13624;
shift = G__13625;
continue;
