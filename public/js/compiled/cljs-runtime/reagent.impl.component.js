...
if((i < len)){
var k = (ks[i]);
var G__37164 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__37165 = (i + (1));
m = G__37164;
i = G__37165;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36827 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__36827);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36846 = c;
var G__36846__$1 = (((G__36846 == null))?null:G__36846.prototype);
if((G__36846__$1 == null)){
return null;
} else {
return (G__36846__$1["reagentRender"]);
}
})() == null)))));
});
...
var G__36884 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36884) : reagent.impl.component.as_element.call(null,G__36884));
};
...
while (G__37204__i < G__37204__a.length) {G__37204__a[G__37204__i] = arguments[G__37204__i + 0]; ++G__37204__i;}
  args = new cljs.core.IndexedSeq(G__37204__a,0,null);
} 
return G__37198__delegate.call(this,args);};
G__37198.cljs$lang$maxFixedArity = 0;
G__37198.cljs$lang$applyTo = (function (arglist__37206){
...
var _STAR_current_component_STAR__orig_val__36885 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36886 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36886;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36885;
}});
...
return ((function (G__36888,G__36888__$1){
...
var c = this;
var G__36931_37234 = (c["cljsRatom"]);
if((G__36931_37234 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36931_37234);
}
...
var renders_37239 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_37240 = cljs.core.first(cljs.core.vals(renders_37239));
if((cljs.core.count(renders_37239) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37239))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37240)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37240], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__37015 = name;
switch (G__37015) {
case "":
...
var G__37069 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__37069);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__37073 = fiber;
var G__37073__$1 = (((G__37073 == null))?null:(G__37073["type"]));
if((G__37073__$1 == null)){
return null;
} else {
return (G__37073__$1["displayName"]);
}
})();
var parent = (function (){var G__37074 = fiber;
if((G__37074 == null)){
return null;
} else {
return (G__37074["return"]);
}
})();
var path = (function (){var G__37075 = parent;
var G__37075__$1 = (((G__37075 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__37075) : reagent.impl.component.fiber_component_path.call(null,G__37075)));
if((G__37075__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37075__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__37077 = c;
if((G__37077 == null)){
return null;
} else {
...
return G__37082._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__37091 = c;
if((G__37091 == null)){
return null;
} else {
return (G__37091["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__37110 = c;
if((G__37110 == null)){
return null;
} else {
return G__37110._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__37112 = instance;
if((G__37112 == null)){
return null;
} else {
return (G__37112["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__37113 = instance;
if((G__37113 == null)){
return null;
} else {
return G__37113._currentElement;
}
}
})();
var name = (function (){var G__37114 = elem;
var G__37114__$1 = (((G__37114 == null))?null:(G__37114["type"]));
if((G__37114__$1 == null)){
return null;
} else {
return (G__37114__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__37120 = elem;
if((G__37120 == null)){
return null;
} else {
return (G__37120["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__37123._owner;
}
}
})();
var path = (function (){var G__37124 = owner;
var G__37124__$1 = (((G__37124 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__37124) : reagent.impl.component.component_path.call(null,G__37124)));
if((G__37124__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37124__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__37125 = c;
var G__37125__$1 = (((G__37125 == null))?null:G__37125.constructor);
if((G__37125__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__37125__$1);
}
}
})();
