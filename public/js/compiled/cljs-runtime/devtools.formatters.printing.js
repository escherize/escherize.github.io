...
var len__4730__auto___38789 = arguments.length;
var i__4731__auto___38790 = (0);
while(true){
if((i__4731__auto___38790 < len__4730__auto___38789)){
args__4736__auto__.push((arguments[i__4731__auto___38790]));

var G__38791 = (i__4731__auto___38790 + (1));
i__4731__auto___38790 = G__38791;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38666){
var G__38667 = cljs.core.first(seq38666);
var seq38666__$1 = cljs.core.next(seq38666);
var G__38668 = cljs.core.first(seq38666__$1);
var seq38666__$2 = cljs.core.next(seq38666__$1);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38707_SHARP_){
return (!((cljs.core.meta(p1__38707_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38732__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e38737){var _e__36502__auto__ = e38737;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e38744){var _e__36502__auto__ = e38744;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__38769 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__38770 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__38770;

try{var map__38776 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38776__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__38769;
}});
...
;
var temp__5733__auto___38819 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___38819)){
var managed_print_level_38820 = temp__5733__auto___38819;
var _STAR_print_level_STAR__orig_val__38786_38821 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__38787_38822 = managed_print_level_38820;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__38787_38822;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__38786_38821,_STAR_print_level_STAR__temp_val__38787_38822,managed_print_level_38820,temp__5733__auto___38819,writer,opts,job_fn){
return (function (p1__38783_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__38783_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__38786_38821,_STAR_print_level_STAR__temp_val__38787_38822,managed_print_level_38820,temp__5733__auto___38819,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__38786_38821;
}} else {
job_fn();
}
