...
var len__4818__auto___32696 = arguments.length;
var i__4819__auto___32697 = (0);
while(true){
if((i__4819__auto___32697 < len__4818__auto___32696)){
args__4824__auto__.push((arguments[i__4819__auto___32697]));

var G__32698 = (i__4819__auto___32697 + (1));
i__4819__auto___32697 = G__32698;
continue;
} else {
}
break;
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32591,G__32592,seq32590__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32646_SHARP_){
return (!((cljs.core.meta(p1__32646_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32672__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32676){var _e__31306__auto__ = e32676;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e32681){var _e__31306__auto__ = e32681;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32690 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32691 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32691);

try{var map__32692 = opts;
var map__32692__$1 = cljs.core.__destructure_map(map__32692);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32692__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32690);
}});
...
var temp__5751__auto___32703 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___32703)){
var managed_print_level_32704 = temp__5751__auto___32703;
var _STAR_print_level_STAR__orig_val__32694_32705 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32695_32706 = managed_print_level_32704;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32695_32706);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32693_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32693_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32694_32705);
}} else {
job_fn();
}
