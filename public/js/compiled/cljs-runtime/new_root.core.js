...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(new_root.core.app_state,cljs.core.update,new cljs.core.Keyword(null,"thingies","thingies",2070631329),(function (p1__35610_SHARP_){
return ((2) * p1__35610_SHARP_);
}));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35614),new_root$core$iter__35611(cljs.core.chunk_rest(s__35612__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35614),null);
}
} else {
var line = cljs.core.first(s__35612__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"padding","padding",1660304693),"0",new cljs.core.Keyword(null,"margin","margin",-995903681),"-3px auto",new cljs.core.Keyword(null,"border","border",1444987323),"none",new cljs.core.Keyword(null,"font-family","font-family",-667419874),"monospace"], null)], null),line], null),new_root$core$iter__35611(cljs.core.rest(s__35612__$2)));
}
} else {
return null;
}
...
var _STAR_print_newline_STAR__orig_val__35615_35634 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__35616_35635 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__35617_35636 = true;
var _STAR_print_fn_STAR__temp_val__35618_35637 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__35617_35636);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__35618_35637);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__35616_35635);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__35615_35634);
}
...
new_root.core.teaser = (function new_root$core$teaser(p__35620){
...
var _ = map__35621__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35621__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35621__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35621__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35621__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35621__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),"Escherize Zone"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.blog,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632)], null),(function (){var iter__4582__auto__ = (function new_root$core$home_$_iter__35624(s__35625){
return (new cljs.core.LazySeq(null,(function (){
var s__35625__$1 = s__35625;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__35625__$1);
if(temp__5735__auto__){
var s__35625__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__35625__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__35625__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__35627 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__35626 = (0);
while(true){
if((i__35626 < size__4581__auto__)){
var p = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__35626);
cljs.core.chunk_append(b__35627,new_root.core.teaser(p));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__35627),new_root$core$home_$_iter__35624(cljs.core.chunk_rest(s__35625__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__35627),null);
}
} else {
var p = cljs.core.first(s__35625__$2);
return cljs.core.cons(new_root.core.teaser(p),new_root$core$home_$_iter__35624(cljs.core.rest(s__35625__$2)));
}
} else {
return null;
}
...
var map__35629 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new_root.core.posts,parseInt(id));
...
var post = map__35629__$1;
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35629__$1,new cljs.core.Keyword(null,"content","content",15833224));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35629__$1,new cljs.core.Keyword(null,"title","title",636505583));
...
var G__35631 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.current_page], null);
var G__35632 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__35631,G__35632) : reagent.core.render_component.call(null,G__35631,G__35632));
});
