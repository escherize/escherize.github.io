...
var G__37764 = o;
(G__37764[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__38028__delegate = function (args){
...
return G__38028__delegate.call(this,args);};
...
return G__38028__delegate(args);
});
...
var G__37777 = o;
(G__37777[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38031__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__38032__i < G__38032__a.length) {G__38032__a[G__38032__i] = arguments[G__38032__i + 0]; ++G__38032__i;}
  args = new cljs.core.IndexedSeq(G__38032__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38033);
...
var G__37780 = props;
var G__37780__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37780,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37780);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37780__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37791){
var map__37793 = p__37791;
var map__37793__$1 = (((((!((map__37793 == null))))?(((((map__37793.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37793.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37793):map__37793);
var props = map__37793__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37793__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__37793,map__37793__$1,props,class$){
return (function (c){
...
});})(map__37793,map__37793__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37809){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37810__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37810,map__37810__$1,on_write){
return (function (){
...
});})(node_value,map__37810,map__37810__$1,on_write))
);
} else {
...
var G__37822 = jsprops;
(G__37822["defaultValue"] = value);

(G__37822["onChange"] = ((function (G__37822,v,value,on_change){
return (function (p1__37818_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37818_SHARP_);
});})(G__37822,v,value,on_change))
);
...
var vec__37826 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37826,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37826,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37826,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___38066 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___38066 == null)){
} else {
var key_38067 = temp__5739__auto___38066;
(jsprops["key"] = key_38067);
}
...
var temp__5739__auto___38069 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___38069 == null)){
} else {
var key_38070 = temp__5739__auto___38069;
reagent.impl.template.oset(jsprops,"key",key_38070);
}
...
var G__37848 = reagent.impl.template.__GT_NativeWrapper();
(G__37848["name"] = c);
...
var G__37852 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37852) : reagent.impl.template.as_element.call(null,G__37852));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37860){
var G__37861 = cljs.core.first(seq37860);
var seq37860__$1 = cljs.core.next(seq37860);
...
break;
default:
var G__38086 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__38086;
continue;
...
var n__4607__auto___38088 = a.length;
var i_38093 = (0);
while(true){
if((i_38093 < n__4607__auto___38088)){
(a[i_38093] = reagent.impl.template.as_element((a[i_38093])));

var G__38094 = (i_38093 + (1));
i_38093 = G__38094;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___38099 = a.length;
var i_38100 = (0);
while(true){
if((i_38100 < n__4607__auto___38099)){
var val_38101 = (a[i_38100]);
if(((cljs.core.vector_QMARK_(val_38101)) && ((reagent.impl.template.key_from_vec(val_38101) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38100] = reagent.impl.template.as_element(val_38101));

var G__38102 = (i_38100 + (1));
i_38100 = G__38102;
continue;
} else {
}
...
var ctx = ({});
var vec__37906 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37906,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37906,(1),null);
...
case (1):
var G__37927 = comp;
var G__37928 = jsprops;
var G__37929 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37927,G__37928,G__37929);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37926){
