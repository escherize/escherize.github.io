         ...
         [:div {:style "margin:80px"}
          ...
          (let [[headers & rows] (with-open [reader (io/reader "mens_group_sorted.csv")]
            ...
            [:table {:style "margin-top:50px"}
             ...
             (into [:tbody]
                   (mapv (fn [[f l e p]]
                           [:tr.border-solid.border-2.border-sky-500.hover:border-amber-500
                            {:style "margin-top:2px"}
                            [:td.px-4.py-3.whitespace-nowrap f]
                            [:td.px-4.py-3.whitespace-nowrap l]
                            [:td.px-4.py-3.whitespace-nowrap e]
                            [:td.px-4.py-3.whitespace-nowrap p]])
                         rows))])
