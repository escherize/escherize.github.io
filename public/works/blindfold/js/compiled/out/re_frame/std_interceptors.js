...
var vec__30659_30662 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_30663 = cljs.core.nth.call(null,vec__30659_30662,(0),null);
var only_after_30664 = cljs.core.nth.call(null,vec__30659_30662,(1),null);
var db_changed_QMARK__30665 = (cljs.core.some_QMARK_.call(null,only_before_30663)) || (cljs.core.some_QMARK_.call(null,only_after_30664));
if(db_changed_QMARK__30665){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_30663);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_30664);
...
var map__30672 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__30672__$1 = ((((!((map__30672 == null)))?((((map__30672.cljs$lang$protocol_mask$partition0$ & (64))) || (map__30672.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30672):map__30672);
var db = cljs.core.get.call(null,map__30672__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__30672__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__30680 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__30680__$1;
var event = cljs.core.get.call(null,map__30680__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28475__auto___30683 = arguments.length;
var i__28476__auto___30684 = (0);
while(true){
if((i__28476__auto___30684 < len__28475__auto___30683)){
args__28482__auto__.push((arguments[i__28476__auto___30684]));

var G__30685 = (i__28476__auto___30684 + (1));
i__28476__auto___30684 = G__30685;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq30682){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30682));
});
...
var args__28482__auto__ = [];
var len__28475__auto___30691 = arguments.length;
var i__28476__auto___30692 = (0);
while(true){
if((i__28476__auto___30692 < len__28475__auto___30691)){
args__28482__auto__.push((arguments[i__28476__auto___30692]));

var G__30693 = (i__28476__auto___30692 + (1));
i__28476__auto___30692 = G__30693;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__30686_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__30687_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__30687_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq30688){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__30689,G__30690,seq30688__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1481770131490