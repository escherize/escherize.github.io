...
if(!((function (){var G__29698 = app_db;
if(G__29698){
...
return G__29698.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__29698.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__29698);
} else {
return false;
}
}
...
while (G__29703__i < G__29703__a.length) {G__29703__a[G__29703__i] = arguments[G__29703__i + 0]; ++G__29703__i;}
  args = new cljs.core.IndexedSeq(G__29703__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__29704){
var args = cljs.core.seq(arglist__29704);
...
return cljs.core.get_in.call(null,new_db,p1__29705_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__29706_SHARP_){
return cljs.core.get_in.call(null,db,p1__29706_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__29707__i < G__29707__a.length) {G__29707__a[G__29707__i] = arguments[G__29707__i + 2]; ++G__29707__i;}
  in_paths = new cljs.core.IndexedSeq(G__29707__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__29708){
var f = cljs.core.first(arglist__29708);
arglist__29708 = cljs.core.next(arglist__29708);
var out_path = cljs.core.first(arglist__29708);
var in_paths = cljs.core.rest(arglist__29708);
...
//# sourceMappingURL=middleware.js.map?rel=1436273474938