...
var map__42436 = top_item;
var map__42436__$1 = ((((!((map__42436 == null)))?((((map__42436.cljs$lang$protocol_mask$partition0$ & (64))) || (map__42436.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42436):map__42436);
var file = cljs.core.get.call(null,map__42436__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__42436__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42436__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e42435){var _e = e42435;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___42438 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___42438)){
var seen_errors_42439 = temp__4655__auto___42438;
if(cljs.core.truth_(seen_errors_42439.has(self))){
} else {
seen_errors_42439.add(self);

var temp__4657__auto___42440 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___42440)){
var sense_42441 = temp__4657__auto___42440;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_42441)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1481770151941