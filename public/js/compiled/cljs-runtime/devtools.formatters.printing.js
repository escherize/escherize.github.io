...
var G__27624 = (i__4731__auto___27621 + (1));
i__4731__auto___27621 = G__27624;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27533){
var G__27537 = cljs.core.first(seq27533);
var seq27533__$1 = cljs.core.next(seq27533);
var G__27538 = cljs.core.first(seq27533__$1);
var seq27533__$2 = cljs.core.next(seq27533__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27537,G__27538,seq27533__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27563_SHARP_){
return (!((cljs.core.meta(p1__27563_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27579__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27585){var _e__26426__auto__ = e27585;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e27591){var _e__26426__auto__ = e27591;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27597 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27598 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27598;

try{var map__27605 = opts;
var map__27605__$1 = (((((!((map__27605 == null))))?(((((map__27605.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27605.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27605):map__27605);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27605__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27597;
}});
...
;
var temp__5718__auto___27647 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5718__auto___27647)){
var managed_print_level_27648 = temp__5718__auto___27647;
var _STAR_print_level_STAR__orig_val__27614_27649 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27615_27650 = managed_print_level_27648;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27615_27650;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__27614_27649,_STAR_print_level_STAR__temp_val__27615_27650,managed_print_level_27648,temp__5718__auto___27647,writer,opts,job_fn){
return (function (p1__27610_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27610_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__27614_27649,_STAR_print_level_STAR__temp_val__27615_27650,managed_print_level_27648,temp__5718__auto___27647,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27614_27649;
}} else {
job_fn();
}
