...
var o27648 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27648["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27649 = temp__5733__auto____$1;
...
var o__27331__auto__ = f;
return (o__27331__auto__["toString"]).call(o__27331__auto__);
} else {
return "";
}
...
try{var o__27331__auto___27889 = t;
(o__27331__auto___27889["cljs$lang$ctorPrWriter"]).call(o__27331__auto___27889,t,writer);
}catch (e27665){var __27890 = e27665;
}
...
var char_code = (function (){var o__27331__auto__ = (new String(char$));
return (o__27331__auto__["charCodeAt"]).call(o__27331__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27331__auto__ = String;
return (o__27331__auto__["fromCharCode"]).call(o__27331__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27674 = num_code;
switch (G__27674) {
case (1):
return (185);
...
var o__27331__auto__ = String;
return (o__27331__auto__["fromCharCode"]).call(o__27331__auto__,superscript_code);
});
/**
...
}catch (e27684){var _e__27348__auto__ = e27684;
return false;
}})())){
...
var vec__27686 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27686,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27692 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27692["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27693 = temp__5733__auto____$1;
return (o27693["nameToPath"]);
} else {
return null;
}
} else {
...
var G__27919 = (i__4731__auto___27917 + (1));
i__4731__auto___27917 = G__27919;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27713){
var vec__27714 = p__27713;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27714,(0),null);
...
var G__27920 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27921 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27920;
remaining_tokens = G__27921;
continue;
}
}
break;
...
var vec__27727 = cljs.core.split_with((function (p1__27726_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27726_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27727,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27727,(1),null);
...
var vec__27737 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27737,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27737,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27927 = cljs.core.rest(remaining_tokens);
var G__27928 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27927;
name_tokens = G__27928;
continue;
} else {
...
var vec__27746 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27746,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27746,(1),null);
var vec__27749 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27749,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27749,(1),null);
var vec__27752 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27752,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27752,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27752,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27752,(3),null);
...
var vec__27761 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27761,(4),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27764 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27764,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27764,(1),null);
var vec__27767 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27767,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27767,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27770 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27770) : devtools.munging.parse_fn_info_deep.call(null,G__27770));
})()));
}
} else {
return fn_info;
...
var G__27968 = (arity + (1));
var G__27969 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27777){
var vec__27778 = p__27777;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27778,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27778,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27782_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27783_SHARP_);
...
var G__27996 = (i__4731__auto___27992 + (1));
i__4731__auto___27992 = G__27996;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27787){
var vec__27788 = p__27787;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27788,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27785){
var G__27786 = cljs.core.first(seq27785);
var seq27785__$1 = cljs.core.next(seq27785);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27786,seq27785__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27802__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27802__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27802__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27802__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27803 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27803,(5),null);
...
var o__27331__auto__ = f;
return (o__27331__auto__["getBasis"]).call(o__27331__auto__);
});
/**
...
}catch (e27833){var _e__27348__auto__ = e27833;
...
var G__28042 = (obj[cljs.core.first(path)]);
var G__28043 = cljs.core.rest(path);
obj = G__28042;
path = G__28043;
continue;
} else {
...
return (function (accum,p__27853){
var vec__27854 = p__27853;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27854,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27854,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27870){
var vec__27871 = p__27870;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27871,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27871,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27871,(2),null);
...
return (function (p__27880){
var vec__27882 = p__27880;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27882,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27882,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__27882,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27878_SHARP_){
return (obj[cljs.core.first(p1__27878_SHARP_)]);
});})(name,sorted_matches,vec__27882,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
