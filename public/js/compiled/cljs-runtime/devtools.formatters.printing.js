...
var len__4789__auto___33045 = arguments.length;
var i__4790__auto___33046 = (0);
while(true){
if((i__4790__auto___33046 < len__4789__auto___33045)){
args__4795__auto__.push((arguments[i__4790__auto___33046]));

var G__33048 = (i__4790__auto___33046 + (1));
i__4790__auto___33046 = G__33048;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32914){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32915,G__32916,seq32914__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32962_SHARP_){
return (!((cljs.core.meta(p1__32962_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32983__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32991){var _e__31410__auto__ = e32991;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e32993){var _e__31410__auto__ = e32993;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__33000 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__33001 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__33001);

try{var map__33003 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33003__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__33000);
}});
...
var temp__5733__auto___33081 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___33081)){
var managed_print_level_33082 = temp__5733__auto___33081;
var _STAR_print_level_STAR__orig_val__33030_33083 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__33031_33084 = managed_print_level_33082;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__33031_33084);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__33018_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__33018_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__33030_33083);
}} else {
job_fn();
}
