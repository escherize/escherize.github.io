...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7115__auto__,writer__7116__auto__,opt__7117__auto__){
return cljs.core._write(writer__7116__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__16539 = o;
(G__16539[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__16540__delegate = function (args){
...
while (G__16541__i < G__16541__a.length) {G__16541__a[G__16541__i] = arguments[G__16541__i + 0]; ++G__16541__i;}
  args = new cljs.core.IndexedSeq(G__16541__a,0);
} 
return G__16540__delegate.call(this,args);};
G__16540.cljs$lang$maxFixedArity = 0;
G__16540.cljs$lang$applyTo = (function (arglist__16542){
var args = cljs.core.seq(arglist__16542);
return G__16540__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6497__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6497__auto__){
var and__6497__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6497__auto____$1){
var and__6497__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__16547 = jsprops;
(G__16547["defaultValue"] = value);

(G__16547["onChange"] = ((function (G__16547,v,value,on_change){
return (function (p1__16545_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16545_SHARP_);
});})(G__16547,v,value,on_change))
);
...
var vec__16552 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16552,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16552,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16552,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___16555 = reagent.impl.template.key_from_vec(v);
if((temp__4429__auto___16555 == null)){
} else {
var key_16556 = temp__4429__auto___16555;
...
var G__16558 = (new reagent.impl.template.NativeWrapper());
(G__16558["name"] = c);
...
var G__16560 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__16560) : reagent.impl.template.as_element.call(null,G__16560));
} else {
...
var len__7578__auto___16566 = arguments.length;
var i__7579__auto___16567 = (0);
while(true){
if((i__7579__auto___16567 < len__7578__auto___16566)){
args__7585__auto__.push((arguments[i__7579__auto___16567]));

var G__16568 = (i__7579__auto___16567 + (1));
i__7579__auto___16567 = G__16568;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7586__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16564){
var G__16565 = cljs.core.first(seq16564);
var seq16564__$1 = cljs.core.next(seq16564);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__16565,seq16564__$1);
});
...
break;
default:
var G__16572 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__16572;
continue;
...
var n__7423__auto___16573 = a.length;
var i_16574 = (0);
while(true){
if((i_16574 < n__7423__auto___16573)){
(a[i_16574] = reagent.impl.template.as_element((a[i_16574])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7423__auto___16576 = a.length;
var i_16577 = (0);
while(true){
if((i_16577 < n__7423__auto___16576)){
var val_16578 = (a[i_16577]);
if((cljs.core.vector_QMARK_(val_16578)) && ((reagent.impl.template.key_from_vec(val_16578) == null))){
(o["no-key"] = true);
} else {
}

(a[i_16577] = reagent.impl.template.as_element(val_16578));

var G__16579 = (i_16577 + (1));
i_16577 = G__16579;
continue;
} else {
}
...
var ctx = {};
var vec__16581 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16581,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16581,(1),null);
...
var G__16583 = (cljs.core.count(argv) - first_child);
switch (G__16583) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__16583){
