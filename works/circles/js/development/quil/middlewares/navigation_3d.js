...
var vec__22757 = axis;
var a_x = cljs.core.nth.call(null,vec__22757,(0),null);
var a_y = cljs.core.nth.call(null,vec__22757,(1),null);
var a_z = cljs.core.nth.call(null,vec__22757,(2),null);
var vec__22760 = v;
var x = cljs.core.nth.call(null,vec__22760,(0),null);
var y = cljs.core.nth.call(null,vec__22760,(1),null);
var z = cljs.core.nth.call(null,vec__22760,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__22763,p__22764){
var vec__22765 = p__22763;
var u1 = cljs.core.nth.call(null,vec__22765,(0),null);
var u2 = cljs.core.nth.call(null,vec__22765,(1),null);
var u3 = cljs.core.nth.call(null,vec__22765,(2),null);
var vec__22768 = p__22764;
var v1 = cljs.core.nth.call(null,vec__22768,(0),null);
var v2 = cljs.core.nth.call(null,vec__22768,(1),null);
var v3 = cljs.core.nth.call(null,vec__22768,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__22771_SHARP_){
return (p1__22771_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__22772_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__22773_SHARP_,angle_lr),angle_ud);
...
var map__22775 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__22775__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__22775__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__22777 = cljs.core._EQ_;
var expr__22778 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__22777.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__22778))){
return straight;
} else {
if(cljs.core.truth_(pred__22777.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__22778))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__22777.call(null,quil.middlewares.navigation_3d.space,expr__22778))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__22777.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__22778))){
return up;
} else {
if(cljs.core.truth_(pred__22777.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__22778))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__22777.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__22778))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__22775,map__22775__$1,up,straight){
return (function (p1__22774_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__22774_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__22775,map__22775__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__22780_SHARP_);
});})(initial_state))
);
});
/**
...
var map__22781_22792 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__22781_22793__$1 = ((((!((map__22781_22792 == null)))?(((((map__22781_22792.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22781_22792.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22781_22792):map__22781_22792);
var vec__22782_22794 = cljs.core.get.call(null,map__22781_22793__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_22795 = cljs.core.nth.call(null,vec__22782_22794,(0),null);
var c_y_22796 = cljs.core.nth.call(null,vec__22782_22794,(1),null);
var c_z_22797 = cljs.core.nth.call(null,vec__22782_22794,(2),null);
var vec__22785_22798 = cljs.core.get.call(null,map__22781_22793__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_22799 = cljs.core.nth.call(null,vec__22785_22798,(0),null);
var u_y_22800 = cljs.core.nth.call(null,vec__22785_22798,(1),null);
var u_z_22801 = cljs.core.nth.call(null,vec__22785_22798,(2),null);
var vec__22788_22802 = cljs.core.get.call(null,map__22781_22793__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_22803 = cljs.core.nth.call(null,vec__22788_22802,(0),null);
var p_y_22804 = cljs.core.nth.call(null,vec__22788_22802,(1),null);
var p_z_22805 = cljs.core.nth.call(null,vec__22788_22802,(2),null);
quil.core.camera.call(null,p_x_22803,p_y_22804,p_z_22805,(p_x_22803 + c_x_22795),(p_y_22804 + c_y_22796),(p_z_22805 + c_z_22797),u_x_22799,u_y_22800,u_z_22801);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1525371769169
