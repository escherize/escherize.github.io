...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq33101){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33102,G__33103,seq33101__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__33122_SHARP_){
return (!((cljs.core.meta(p1__33122_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33127__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e33134){var _e__32342__auto__ = e33134;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e33136){var _e__32342__auto__ = e33136;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__33138 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__33139 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__33139);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33140__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__33138);
}});
...
var temp__5733__auto___33165 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___33165)){
var managed_print_level_33166 = temp__5733__auto___33165;
var _STAR_print_level_STAR__orig_val__33144_33167 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__33145_33168 = managed_print_level_33166;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__33145_33168);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__33143_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__33143_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__33144_33167);
}} else {
job_fn();
}
