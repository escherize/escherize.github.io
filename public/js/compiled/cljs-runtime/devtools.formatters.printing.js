...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32558){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32559,G__32560,seq32558__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32580_SHARP_){
return (!((cljs.core.meta(p1__32580_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32600__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32610){var _e__31328__auto__ = e32610;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e32617){var _e__31328__auto__ = e32617;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32622 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32623 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32623);

try{var map__32625 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32625__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32622);
}});
...
var temp__5733__auto___32703 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___32703)){
var managed_print_level_32705 = temp__5733__auto___32703;
var _STAR_print_level_STAR__orig_val__32637_32706 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32638_32707 = managed_print_level_32705;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32638_32707);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32631_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32631_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32637_32706);
}} else {
job_fn();
}
