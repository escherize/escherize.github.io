...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(new_root.core.app_state,cljs.core.update,new cljs.core.Keyword(null,"thingies","thingies",2070631329),(function (p1__67707_SHARP_){
return ((2) * p1__67707_SHARP_);
}));
});
...
new_root.core.teaser = (function new_root$core$teaser(p__67708){
...
var _ = map__67709__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"content","content",15833224));
var no_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"no-content","no-content",-1860206018));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67709__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
...
return ((-1) * (function (){var G__67711 = ((-1) * x);
return Math.sqrt(G__67711);
})());
}
});
...
new_root.core.style_fn = (function new_root$core$style_fn(p__67712){
...
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67713__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67713__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var h = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67713__$1,new cljs.core.Keyword(null,"h","h",1109658740));
var unit_x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67713__$1,new cljs.core.Keyword(null,"unit-x","unit-x",-841417847));
var unit_y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67713__$1,new cljs.core.Keyword(null,"unit-y","unit-y",-235486817));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"box-shadow","box-shadow",1600206755),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_root.core.squirt(x)),"px ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_root.core.squirt(y)),"px ","0px ","0px ","#DBBFCE"].join(''),new cljs.core.Keyword(null,"border-radius","border-radius",419594011),new_root.core.clamp((0),((h / (4)) - (150)),(40))], null);
});
...
new_root.core.shadow_teaser = (function new_root$core$shadow_teaser(_STAR_pointer,p__67715){
...
var _ = map__67716__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var no_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"no-content","no-content",-1860206018));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67716__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
var _STAR_my_position = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentVector.EMPTY);
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (this$){
return cljs.core.reset_BANG_(_STAR_my_position,new_root.neumorph.find_location(reagent.core.dom_node(this$)));
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (_STAR_pointer__$1,content__$1){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(cnt,(function (p1__67718_SHARP_){
return (p1__67718_SHARP_ + 0.05);
}));

cljs.core.reset_BANG_(new_root.core._STAR_pointer,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.to_scale(new_root.core.height,(function (){var G__67719 = cljs.core.deref(cnt);
return Math.sin(G__67719);
})()),((2) * new_root.core.to_scale(new_root.core.width,(function (){var G__67720 = cljs.core.deref(cnt);
return Math.sin(G__67720);
})()))], null));
...
var p = map__67725__$1;
var exclude_post_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67725__$1,new cljs.core.Keyword(null,"exclude-post?","exclude-post?",-1796908485));
cljs.core.chunk_append(b__67724,(cljs.core.truth_(exclude_post_QMARK_)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.shadow_teaser,new_root.core._STAR_pointer,p], null)));

var G__67737 = (i__67723 + (1));
i__67723 = G__67737;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67724),new_root$core$home_$_iter__67721(cljs.core.chunk_rest(s__67722__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67724),null);
}
} else {
var map__67727 = cljs.core.first(s__67722__$2);
...
var p = map__67727__$1;
var exclude_post_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67727__$1,new cljs.core.Keyword(null,"exclude-post?","exclude-post?",-1796908485));
return cljs.core.cons((cljs.core.truth_(exclude_post_QMARK_)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.shadow_teaser,new_root.core._STAR_pointer,p], null)),new_root$core$home_$_iter__67721(cljs.core.rest(s__67722__$2)));
}
} else {
return null;
}
...
var c__4580__auto__ = cljs.core.chunk_first(s__67730__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__67732 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__67731 = (0);
while(true){
if((i__67731 < size__4581__auto__)){
var project = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__67731);
cljs.core.chunk_append(b__67732,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/works/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(project)].join('')], null),clojure.string.capitalize(project)], null));

var G__67738 = (i__67731 + (1));
i__67731 = G__67738;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__67732),new_root$core$projects_$_iter__67729(cljs.core.chunk_rest(s__67730__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__67732),null);
}
} else {
var project = cljs.core.first(s__67730__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/works/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(project)].join('')], null),clojure.string.capitalize(project)], null),new_root$core$projects_$_iter__67729(cljs.core.rest(s__67730__$2)));
}
} else {
return null;
}
...
var map__67733 = (function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(posts,id);
...
var post = map__67733__$1;
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67733__$1,new cljs.core.Keyword(null,"content","content",15833224));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67733__$1,new cljs.core.Keyword(null,"title","title",636505583));
...
var G__67735 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.current_page], null);
var G__67736 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__67735,G__67736) : reagent.core.render_component.call(null,G__67735,G__67736));
});
