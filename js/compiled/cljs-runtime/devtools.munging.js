...
var o27205 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27205["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27206 = temp__5718__auto____$1;
return (o27206["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26397__auto__ = f;
return (o__26397__auto__["toString"]).call(o__26397__auto__);
} else {
return "";
}
}catch (e27209){var _ = e27209;
return "";
}});
...
try{var o__26397__auto___27478 = t;
(o__26397__auto___27478["cljs$lang$ctorPrWriter"]).call(o__26397__auto___27478,t,writer);
}catch (e27219){var __27479 = e27219;
}
...
var char_code = (function (){var o__26397__auto__ = (new String(char$));
return (o__26397__auto__["charCodeAt"]).call(o__26397__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26397__auto__ = String;
return (o__26397__auto__["fromCharCode"]).call(o__26397__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27224 = num_code;
switch (G__27224) {
case (1):
return (185);
...
var o__26397__auto__ = String;
return (o__26397__auto__["fromCharCode"]).call(o__26397__auto__,superscript_code);
});
/**
...
}catch (e27239){var _e__26426__auto__ = e27239;
return false;
}})())){
...
var vec__27240 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o27252 = temp__5718__auto__;
var temp__5718__auto____$1 = (o27252["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o27253 = temp__5718__auto____$1;
return (o27253["nameToPath"]);
} else {
return null;
}
} else {
...
var G__27500 = (i__4731__auto___27495 + (1));
i__4731__auto___27495 = G__27500;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27256){
var vec__27257 = p__27256;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27257,(0),null);
...
var G__27502 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27503 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27502;
remaining_tokens = G__27503;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27254){
var G__27255 = cljs.core.first(seq27254);
var seq27254__$1 = cljs.core.next(seq27254);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27255,seq27254__$1);
});
...
var vec__27272 = cljs.core.split_with((function (p1__27268_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27268_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27272,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27272,(1),null);
...
var vec__27281 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27281,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27281,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27506 = cljs.core.rest(remaining_tokens);
var G__27507 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27506;
name_tokens = G__27507;
continue;
} else {
...
var vec__27288 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27288,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27288,(1),null);
var vec__27291 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27291,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27291,(1),null);
var vec__27294 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27294,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27294,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27294,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27294,(3),null);
...
var vec__27308 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27308,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__27322 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27322,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27322,(1),null);
var vec__27325 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27325,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27325,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27331 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27331) : devtools.munging.parse_fn_info_deep.call(null,G__27331));
})()));
}
} else {
return fn_info;
...
var G__27530 = (arity + (1));
var G__27531 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27341){
var vec__27342 = p__27341;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27342,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27342,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27345_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27346_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27357){
var vec__27358 = p__27357;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27358,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27352){
var G__27355 = cljs.core.first(seq27352);
var seq27352__$1 = cljs.core.next(seq27352);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27355,seq27352__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27379__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27379__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27379__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27379__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27380 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27380,(5),null);
...
var o__26397__auto__ = f;
return (o__26397__auto__["getBasis"]).call(o__26397__auto__);
});
/**
...
}catch (e27398){var _e__26426__auto__ = e27398;
...
var G__27564 = (obj[cljs.core.first(path)]);
var G__27565 = cljs.core.rest(path);
obj = G__27564;
path = G__27565;
continue;
} else {
...
return (function (accum,p__27411){
var vec__27412 = p__27411;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27412,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27412,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27449){
var vec__27450 = p__27449;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27450,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27450,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27450,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27467,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27467,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__27467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27462_SHARP_){
return (obj[cljs.core.first(p1__27462_SHARP_)]);
});})(name,sorted_matches,vec__27467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
