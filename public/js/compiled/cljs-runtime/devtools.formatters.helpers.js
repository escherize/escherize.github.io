...
var G__32581 = devtools.prefs.pref(v);
v = G__32581;
continue;
} else {
return v;
...
}catch (e32534){var _e__31306__auto__ = e32534;
return false;
}})();
...
}catch (e32540){var _e__31306__auto__ = e32540;
return false;
}})();
...
}catch (e32547){var _e__31306__auto__ = e32547;
return false;
}}
}
});
...
var vec__32560 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32560,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32560,(1),null);
...
return cljs.core.some((function (p1__32569_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__32569_SHARP_);
}),template);
});
