...
}catch (e34404){var _e__31328__auto__ = e34404;
return false;
...
}catch (e34409){var _e__31328__auto__ = e34409;
return false;
...
}catch (e34413){var _e__31328__auto__ = e34413;
return false;
...
}catch (e34416){var _e__31328__auto__ = e34416;
return false;
...
}catch (e34422){var _e__31328__auto__ = e34422;
return false;
}})())){
...
}catch (e34424){var _e__31328__auto__ = e34424;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__34426 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__34427 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__34427);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__34426);
}});
});
...
return (function() { 
var G__34466__delegate = function (args){
...
while (G__34468__i < G__34468__a.length) {G__34468__a[G__34468__i] = arguments[G__34468__i + 0]; ++G__34468__i;}
  args = new cljs.core.IndexedSeq(G__34468__a,0,null);
} 
return G__34466__delegate.call(this,args);};
G__34466.cljs$lang$maxFixedArity = 0;
G__34466.cljs$lang$applyTo = (function (arglist__34469){
var args = cljs.core.seq(arglist__34469);
return G__34466__delegate(args);
});
