...
var o40233 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40233["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40234 = temp__5733__auto____$1;
...
var o__39276__auto__ = f;
return (o__39276__auto__["toString"]).call(o__39276__auto__);
} else {
return "";
}
...
try{var o__39276__auto___40662 = t;
(o__39276__auto___40662["cljs$lang$ctorPrWriter"]).call(o__39276__auto___40662,t,writer);
}catch (e40255){var __40663 = e40255;
}
...
var char_code = (function (){var o__39276__auto__ = (new String(char$));
return (o__39276__auto__["charCodeAt"]).call(o__39276__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39276__auto__ = String;
return (o__39276__auto__["fromCharCode"]).call(o__39276__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40279 = num_code;
switch (G__40279) {
case (1):
return (185);
...
var o__39276__auto__ = String;
return (o__39276__auto__["fromCharCode"]).call(o__39276__auto__,superscript_code);
});
/**
...
}catch (e40334){var _e__39336__auto__ = e40334;
return false;
}})())){
...
var vec__40338 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40338,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o40349 = temp__5733__auto__;
var temp__5733__auto____$1 = (o40349["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o40350 = temp__5733__auto____$1;
return (o40350["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40363){
var vec__40364 = p__40363;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40364,(0),null);
...
var G__40685 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__40686 = cljs.core.butlast(remaining_tokens);
name_tokens = G__40685;
remaining_tokens = G__40686;
continue;
}
}
break;
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40360,seq40359__$1);
}));
...
var vec__40397 = cljs.core.split_with((function (p1__40394_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40394_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40397,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40397,(1),null);
...
var vec__40408 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40408,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40408,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__40691 = cljs.core.rest(remaining_tokens);
var G__40692 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__40691;
name_tokens = G__40692;
continue;
} else {
...
var vec__40429 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40429,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40429,(1),null);
var vec__40432 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40432,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40432,(1),null);
var vec__40435 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40435,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40435,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40435,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40435,(3),null);
...
var vec__40448 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40448,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__40455 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40455,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40455,(1),null);
var vec__40462 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40462,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40462,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__40471 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__40471) : devtools.munging.parse_fn_info_deep.call(null,G__40471));
})()));
}
} else {
return fn_info;
...
var G__40724 = (arity + (1));
var G__40725 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40487){
var vec__40488 = p__40487;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40488,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40488,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40512_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__40512_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40513_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__40513_SHARP_);
}),sorted_infos);
...
var G__40741 = (i__4790__auto___40737 + (1));
i__4790__auto___40737 = G__40741;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40524){
var vec__40525 = p__40524;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40525,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40518){
var G__40519 = cljs.core.first(seq40518);
var seq40518__$1 = cljs.core.next(seq40518);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40519,seq40518__$1);
}));
...
var map__40577 = options;
var map__40577__$1 = (((((!((map__40577 == null))))?(((((map__40577.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40577.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40577):map__40577);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40577__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40577__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40577__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40577__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40578 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(5),null);
...
var o__39276__auto__ = f;
return (o__39276__auto__["getBasis"]).call(o__39276__auto__);
});
/**
...
}catch (e40593){var _e__39336__auto__ = e40593;
...
var G__40760 = (obj[cljs.core.first(path)]);
var G__40761 = cljs.core.rest(path);
obj = G__40760;
path = G__40761;
continue;
} else {
...
var _STAR_ = (function (accum,p__40633){
var vec__40634 = p__40633;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40634,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40634,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40639){
var vec__40640 = p__40639;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40640,(2),null);
...
var post_process = (function (p__40653){
var vec__40654 = p__40653;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40654,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40654,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40646_SHARP_){
return (obj[cljs.core.first(p1__40646_SHARP_)]);
}),sorted_matches);
