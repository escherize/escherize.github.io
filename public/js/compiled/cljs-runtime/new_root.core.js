...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(new_root.core.app_state,cljs.core.update,new cljs.core.Keyword(null,"thingies","thingies",2070631329),(function (p1__42894_SHARP_){
return ((2) * p1__42894_SHARP_);
}));
});
...
new_root.core.post_8 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"light-strips",new cljs.core.Keyword(null,"sorder","sorder",2122475113),(6),new cljs.core.Keyword(null,"title","title",636505583),"Working with LED Strips",new cljs.core.Keyword(null,"pure","pure",1433370394),true,new cljs.core.Keyword(null,"preview","preview",451279890),(function (){
...
new_root.core.teaser = (function new_root$core$teaser(p__42896){
...
var _ = map__42897__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42897__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42897__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42897__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42897__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42897__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
...
new_root.core.shadow_teaser = (function new_root$core$shadow_teaser(_STAR_pointer,p__42902){
...
var _ = map__42903__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42903__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42903__$1,new cljs.core.Keyword(null,"title","title",636505583));
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42903__$1,new cljs.core.Keyword(null,"preview","preview",451279890));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42903__$1,new cljs.core.Keyword(null,"content","content",15833224));
var release = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42903__$1,new cljs.core.Keyword(null,"release","release",-1534371381));
var _STAR_my_position = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentVector.EMPTY);
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (this$){
return cljs.core.reset_BANG_(_STAR_my_position,new_root.neumorph.find_location(reagent.core.dom_node(this$)));
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (_STAR_pointer__$1,content__$1){
...
var G__42905 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [typeof id1 === 'string',typeof id2 === 'string'], null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__42905)){
return id2;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__42905)){
return id1;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__42905)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__42905)){
return cljs.core.first(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id1,id2], null)));
} else {
...
var with_let42907 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let42907","with-let42907",-976977769));
var temp__5739__auto___42925 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___42925 == null)){
} else {
var c__35376__auto___42926 = temp__5739__auto___42925;
if((with_let42907.generation === c__35376__auto___42926.ratomGeneration)){
...
(with_let42907.generation = c__35376__auto___42926.ratomGeneration);
}


var init42908 = (with_let42907.length === (0));
var handler = ((init42908)?(with_let42907[(0)] = (function (p1__42906_SHARP_){
return cljs.core.reset_BANG_(new_root.core._STAR_pointer,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__42906_SHARP_.pageX,p1__42906_SHARP_.pageY], null));
})):(with_let42907[(0)]));
var ___$1 = ((init42908)?(with_let42907[(1)] = document.addEventListener("mousemove",handler)):(with_let42907[(1)]));
var touch_handler = ((init42908)?(with_let42907[(2)] = (function (e){
...
var c__4580__auto__ = cljs.core.chunk_first(s__42910__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42912 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42911 = (0);
while(true){
if((i__42911 < size__4581__auto__)){
var map__42913 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42911);
...
var p = map__42913__$1;
var exclude_post_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42913__$1,new cljs.core.Keyword(null,"exclude-post?","exclude-post?",-1796908485));
cljs.core.chunk_append(b__42912,(cljs.core.truth_(exclude_post_QMARK_)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.shadow_teaser,new_root.core._STAR_pointer,p], null)));

var G__42927 = (i__42911 + (1));
i__42911 = G__42927;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42912),new_root$core$home_$_iter__42909(cljs.core.chunk_rest(s__42910__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42912),null);
}
} else {
var map__42915 = cljs.core.first(s__42910__$2);
...
var p = map__42915__$1;
var exclude_post_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42915__$1,new cljs.core.Keyword(null,"exclude-post?","exclude-post?",-1796908485));
return cljs.core.cons((cljs.core.truth_(exclude_post_QMARK_)?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.shadow_teaser,new_root.core._STAR_pointer,p], null)),new_root$core$home_$_iter__42909(cljs.core.rest(s__42910__$2)));
}
} else {
return null;
}
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42920),new_root$core$projects_$_iter__42917(cljs.core.chunk_rest(s__42918__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42920),null);
}
} else {
var project = cljs.core.first(s__42918__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",-793805698),["/works/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(project)].join('')], null),clojure.string.capitalize(project)], null),new_root$core$projects_$_iter__42917(cljs.core.rest(s__42918__$2)));
}
} else {
return null;
}
...
var map__42921 = (function (){var or__4185__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(posts,id);
...
var post = map__42921__$1;
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42921__$1,new cljs.core.Keyword(null,"content","content",15833224));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42921__$1,new cljs.core.Keyword(null,"title","title",636505583));
...
var G__42923 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_root.core.current_page], null);
var G__42924 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__42923,G__42924) : reagent.core.render_component.call(null,G__42923,G__42924));
});
