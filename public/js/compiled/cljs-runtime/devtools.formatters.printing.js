...
var G__32676 = (i__4731__auto___32674 + (1));
i__4731__auto___32674 = G__32676;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32590){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32591,G__32592,seq32590__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32622_SHARP_){
return (!((cljs.core.meta(p1__32622_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32640__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32648){var _e__31338__auto__ = e32648;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e32650){var _e__31338__auto__ = e32650;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32656 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32657 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32657;

try{var map__32658 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32658__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32656;
}});
...
;
var temp__5733__auto___32722 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___32722)){
var managed_print_level_32723 = temp__5733__auto___32722;
var _STAR_print_level_STAR__orig_val__32664_32724 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32665_32725 = managed_print_level_32723;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32665_32725;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__32664_32724,_STAR_print_level_STAR__temp_val__32665_32725,managed_print_level_32723,temp__5733__auto___32722,writer,opts,job_fn){
return (function (p1__32663_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32663_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__32664_32724,_STAR_print_level_STAR__temp_val__32665_32725,managed_print_level_32723,temp__5733__auto___32722,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32664_32724;
}} else {
job_fn();
}
