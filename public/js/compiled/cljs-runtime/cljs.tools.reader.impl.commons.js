...
var G__30492 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30492;
continue;
} else {
return ch;
...
var vec__30434 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30434,(0),null);
return (match === s);
});
...
var len__4730__auto___30505 = arguments.length;
var i__4731__auto___30506 = (0);
while(true){
if((i__4731__auto___30506 < len__4730__auto___30505)){
args__4736__auto__.push((arguments[i__4731__auto___30506]));

var G__30507 = (i__4731__auto___30506 + (1));
i__4731__auto___30506 = G__30507;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30471){
var G__30474 = cljs.core.first(seq30471);
var seq30471__$1 = cljs.core.next(seq30471);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30474,seq30471__$1);
});
...
G__30509.cljs$lang$applyTo = (function (arglist__30513){
var rdr = cljs.core.first(arglist__30513);
var _ = cljs.core.rest(arglist__30513);
